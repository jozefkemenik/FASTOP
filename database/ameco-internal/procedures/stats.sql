...
CREATE PROCEDURE logStatistics(
  ...
  , IN p_type    TEXT CHARSET utf8mb4 COLLATE utf8mb4_0900_ai_ci
  , IN p_uri     TEXT CHARSET utf8mb4 COLLATE utf8mb4_0900_ai_ci
)
BEGIN
    INSERT INTO statistique(userid, datein, agent, addr, type, uri)
    VALUES (p_user_id, now(), p_agent, p_addr, p_type, p_uri);
